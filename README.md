...
Content is present in /src/content. Assets, images, etc are present in the /public folder or in respective content folder

To develop locally clone the repository and do "npm install" and "astro run dev"
